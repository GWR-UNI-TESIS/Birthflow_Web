...
import { PARTOGRAPH_HISTORY_ENDPOINTS } from "./partograph-history-endpoints";
...
export const getPartographHistory = async (partographId) => {
    try {
        const response = await api.get(
            PARTOGRAPH_HISTORY_ENDPOINTS.PARTOGRAPH_HISTORY.GET_PARTOGRAPH_HISTORY(partographId),
