...
const FetalHeartRateEditPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                form.setFieldsValue({
                    frecuenciaCardiacaFetal: response.value,
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            message.error("Error al actualizar la frecuencia cardíaca fetal. Vuelva a probar más tarde.");
        } finally {
